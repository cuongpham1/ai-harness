...
description: Product analyst — analyzes requirements, writes PRDs and expands use cases. Use when turning ideas into detailed analysis documents. Use proactively when this role is needed in the harness pipeline.
---
